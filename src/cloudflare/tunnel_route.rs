...
struct TunnelRouteData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    virtual_network_id: Option<PrimField<String>>,
}

struct TunnelRoute_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<TunnelRouteData>,
}

#[derive(Clone)]
pub struct TunnelRoute(Rc<TunnelRoute_>);
...
impl TunnelRoute {
    ...
    pub fn set_virtual_network_id(self, v: impl Into<PrimField<String>>) -> Self {
...
impl Referable for TunnelRoute {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for TunnelRoute { }

impl ToListMappable for TunnelRoute {
    type O = ListRef<TunnelRouteRef>;
...
impl Resource_ for TunnelRoute_ {
    fn extract_resource_type(&self) -> String {
        "cloudflare_tunnel_route".into()
    }
...
pub struct BuildTunnelRoute {
    ...
    #[doc= "The IPv4 or IPv6 network that should use this tunnel route, in CIDR notation."]
    pub network: PrimField<String>,
    #[doc= "The ID of the tunnel that will service the tunnel route."]
    pub tunnel_id: PrimField<String>,
}

impl BuildTunnelRoute {
    pub fn build(self, stack: &mut Stack) -> TunnelRoute {
        let out = TunnelRoute(Rc::new(TunnelRoute_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(TunnelRouteData {
...
pub struct TunnelRouteRef {
    shared: StackShared,
    base: String,
}

impl Ref for TunnelRouteRef {
