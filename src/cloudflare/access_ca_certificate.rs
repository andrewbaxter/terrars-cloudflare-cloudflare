...
#[derive(Serialize)]
struct AccessCaCertificateData {
...
struct AccessCaCertificate_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<AccessCaCertificateData>,
}

#[derive(Clone)]
pub struct AccessCaCertificate(Rc<AccessCaCertificate_>);

impl AccessCaCertificate {
...
impl Referable for AccessCaCertificate {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for AccessCaCertificate { }

impl ToListMappable for AccessCaCertificate {
    type O = ListRef<AccessCaCertificateRef>;
...
impl Resource_ for AccessCaCertificate_ {
    fn extract_resource_type(&self) -> String {
        "cloudflare_access_ca_certificate".into()
    }
...
pub struct BuildAccessCaCertificate {
    pub tf_id: String,
    #[doc= "The Access Application ID to associate with the CA certificate."]
    pub application_id: PrimField<String>,
}

impl BuildAccessCaCertificate {
    pub fn build(self, stack: &mut Stack) -> AccessCaCertificate {
        let out = AccessCaCertificate(Rc::new(AccessCaCertificate_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(AccessCaCertificateData {
...
pub struct AccessCaCertificateRef {
    shared: StackShared,
    base: String,
}

impl Ref for AccessCaCertificateRef {
